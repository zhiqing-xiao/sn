...
- Section 1.6, Search "RL algorithms are first pre-train". Change 【RL algorithms are first pre-train】 to 【RL models are first pre-trained】. That is, change "algorithms" to "models", and change "pre-train" to "pre-trained".
...
- Chapter 11, PDF Page 371, Search "performance different lemma". Change 【performance different lemma】 to 【performance difference lemma】.
...
- **(Feedback based on the PDF 2023-11-16.)** Section 15.1.2, PDF page 516, first block math in Section 15.1.2, change two 【 $\uptheta$ 】 to 【 $\boldsymbol\uptheta$ 】. `\boldsymbol\uptheta`
